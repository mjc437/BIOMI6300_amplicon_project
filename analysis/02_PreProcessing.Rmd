...
metadata_df$names <- substring(metadata_df$X.Run, 1) # remove the first two characters in the X.run column so that it exactly matches the track_count_df names column 
